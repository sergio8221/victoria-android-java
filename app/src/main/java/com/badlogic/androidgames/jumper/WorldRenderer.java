...
public class WorldRenderer {
	...
	private void renderBob(){
		...
		batcher.drawSprite(world.bob.position.x, world.bob.position.y, side*1.3f, 1.3f, keyFrame);
	}
	...
	private void renderSquirrels(){
		...
		for(int i=0;i<len;i++){
			...
			case 2:
				...
				batcher.drawSprite(squirrel.position.x,squirrel.position.y,side*1.3f,1.3f,keyFrame);
				break;
			case 3:
			case 4:
			case 5:
				...
				batcher.drawSprite(squirrel.position.x,squirrel.position.y,side2*1.3f,1.3f,keyFrame2);
				break;
			case 6:
			case 7:
			case 8:
				...
				batcher.drawSprite(squirrel.position.x,squirrel.position.y,side3*1.3f,1.3f,keyFrame3);
				break;
			}
