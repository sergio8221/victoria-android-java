...
public class Story5 extends GLScreen{
	Camera2D guiCam;
	...
	TextureRegion marlene;
	
	public Story5(Game game){
		super(game);
	...
	public void resume(){
		...
		text = new Texture(glGame,"text5.png");
		textRegion = new TextureRegion(text,0,0,256,256);
		marlene = Assets.bobJump.getKeyFrame(0.1f,Animation.ANIMATION_NONLOOPING);
	}
	...
	public void present(float deltaTime){
		...
		batcher.drawSprite(170, 130, 240, 240, textRegion);
		batcher.endBatch();
		
		batcher.beginBatch(Assets.items);
		batcher.drawSprite(180, 365, 70, 70, marlene);
		batcher.drawSprite(140, 270, 128, 32, Assets.platform);
