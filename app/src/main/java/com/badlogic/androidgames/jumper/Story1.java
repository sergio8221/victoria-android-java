...
public class Story1 extends GLScreen{
	Camera2D guiCam;
	...
	public void resume(){
		...
		text = new Texture(glGame,"text1.png");
	...
	public void present(float deltaTime){
		...
		batcher.drawSprite(190, 130, 290, 290, textRegion);
		batcher.endBatch();
		
		batcher.beginBatch(Assets.items);
		batcher.drawSprite(200, 340, 70, 70, victor);
		batcher.drawSprite(130, 340, 70, 70, Assets.bobHit);
