...
import com.badlogic.androidgames.jumper.VaqueroWorld.DiscoListener;
//import com.badlogic.androidgames.jumper.World.WorldListener;

public class VaqueroScreen extends GLScreen{
	...
	public VaqueroScreen(Game game,int score,int stage){
		super(game);
		state = GAME_READY;
		...
		disco = new VaqueroWorld(discoListener,game,stage);
		renderer = new VaqueroRenderer(glGraphics,batcher,disco);
	...
	private void presentLevelEnd(){
		String topText = "A tomar";
		String bottomText = "porculoo!!!";
		float topWidth = 16 * topText.length();
		float bottomWidth = 16 * bottomText.length();
		Assets.font.drawText(batcher, topText, 160-topWidth/2, 480-190);
		Assets.font.drawText(batcher,bottomText,160-bottomWidth/2,190);
