...
public class Story3 extends GLScreen{
	Camera2D guiCam;
	...
	TextureRegion vaquero;
	TextureRegion victor;
	
	public Story3(Game game){
		super(game);
		...
		batcher = new SpriteBatcher(glGraphics,5);
	}
	...
	public void resume(){
		...
		text = new Texture(glGame,"text3.png");
		textRegion = new TextureRegion(text,0,0,256,256);
		vaquero = Assets.vaquero.getKeyFrame(0.1f,Animation.ANIMATION_NONLOOPING);
		victor = Assets.victor.getKeyFrame(0.3f,Animation.ANIMATION_NONLOOPING);
	}
	...
	public void present(float deltaTime){
		...
		batcher.drawSprite(170, 190, 240, 240, textRegion);
		batcher.endBatch();
		
		batcher.beginBatch(Assets.items);
		batcher.drawSprite(195, 363, 70, 70, victor);
		batcher.drawSprite(140, 350, 70, 70, vaquero);
