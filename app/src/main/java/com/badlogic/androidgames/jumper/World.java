...
public class World {
	...
	public static float HEIGHT_SOFAR = 0; //para acceder a este dato, no sé cómo pollas acceder si no es static
	...
	public World(WorldListener listener,int stage){
		switch(stage){
		case 1:
			totalHeight=15*4;
			break;
	...
	private void generateLevel(){
		...
		while(y<totalHeight-WORLD_WIDTH/2){
			...
			if(y>totalHeight/3 && rand.nextFloat()>0.8f){
