...
public class Story4 extends GLScreen{
	Camera2D guiCam;
	...
	public void resume(){
		...
		text = new Texture(glGame,"text4.png");
		...
		for(int i=0;i<len;i++){
			...
			if(event.type == TouchEvent.TOUCH_UP){
				if(OverlapTester.pointInRectangle(nextBounds, touchPoint)){
					...
					game.setScreen(new Story5(game));
					return;
				}
	...
	public void present(float deltaTime){
		...
		batcher.drawSprite(155, 365, 70, 70, marlene);
