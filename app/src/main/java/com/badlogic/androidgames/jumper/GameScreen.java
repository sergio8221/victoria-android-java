...
public class GameScreen extends GLScreen{
	...
	public GameScreen(Game game,int score,int stage){
		super(game);
		state = GAME_READY;
		...
		world = new World(worldListener,stage);
	...
	private void updateLevelEnd(){
		...
		for(int i=0;i<len;i++){
			...
			state = GAME_READY;*/
			game.setScreen(new StoryPortero(game,lastScore,pantalla+1));
		}
	}
	...
	private void presentRunning(){
		...
		Assets.font.drawText(batcher, "Disco a " + (int)((world.totalHeight-World.WORLD_WIDTH/2)-World.HEIGHT_SOFAR) + "m", 16, 20);//distancia hasta el castillo
	}
	...
	private void presentLevelEnd(){
		String topText = "Has llegado";
		String bottomText = "a la disco!!!";
